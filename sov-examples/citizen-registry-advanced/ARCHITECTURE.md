...
User Machine
    ...
    └─ Citizen Help
       └─ /citizenhelp → /api/citizenhelp → localhost:8010
          └─ Qwen2.5-32B-Instruct on the attested H100 only
...
flowchart LR
   ...
   Help -->|Qwen2.5-32B-Instruct<br/>32.5B, Apache-2.0, bfloat16| H100[NVIDIA H100<br/>cuda:0 only]
...
`5ede1c97bbab6ce5cda5812749b4c0bdf79b18dd` and downloaded from the public Qwen repository.
...
7. Seed Database
   └─ App migration creates the expanded schema, 1,000 fictional records, and read-only health fixtures
